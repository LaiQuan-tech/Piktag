...
function isIndexableProfile(p) {
  ...
  // Abandoned setup. The wizard publishes the username at step 1 but writes
  // tags, links and this flag only on completion, so anyone who drops out
  // midway leaves a live page with nothing on it. profileRobots already
  // gives a tag-less page `noindex`; this keeps the sitemap from listing
  // what the page then asks search engines to ignore.
  //
  // Strictly `=== false`: rows predating the column read as undefined and
  // stay indexable. Treating a missing value as "unfinished" would quietly
  // drop every legacy profile out of the sitemap.
  if (p.onboarding_completed === false) return false;
  return true;
}
...
const TRANSLATIONS = {
  en: {
    ...
    shareAria: 'Share',
    tagsAria: 'Tags',
    summarySentence: 'On PikTag, {{name}}\u2019s tags are {{tags}}.',
    tagJoin: ', ',
    follow: 'Follow',
    ...
    setupPendingTitle: 'Profile not ready yet',
    setupPendingHeading: 'This profile isn\'t ready yet',
    setupPendingText: 'They haven\'t added their tags and contact links yet, so there is nothing to show here.',
    setupPendingOwner: 'Is this you? Open PikTag to finish setting up your profile.',
  ...
  'zh-TW': {
    ...
    shareAria: '分享',
    tagsAria: '標籤',
    summarySentence: '在 PikTag 上，{{name}} 的標籤是 {{tags}}。',
    tagJoin: '、',
    follow: '追蹤',
    ...
    setupPendingTitle: '檔案尚未設定完成',
    setupPendingHeading: '這個檔案還沒設定完成',
    setupPendingText: '他還沒加上標籤和聯絡方式，所以這裡目前沒有東西可以看。',
    setupPendingOwner: '這是你嗎？打開 PikTag 完成你的檔案設定。',
  ...
  'zh-CN': {
    ...
    shareAria: '分享',
    tagsAria: '标签',
    summarySentence: '在 PikTag 上，{{name}} 的标签是 {{tags}}。',
    tagJoin: '、',
    follow: '关注',
    ...
    notFoundBack: '回到 PikTag',
    setupPendingTitle: '档案尚未设置完成',
    setupPendingHeading: '这个档案还没设置完成',
    setupPendingText: '他还没加上标签和联系方式，所以这里目前没有东西可以看。',
    setupPendingOwner: '这是你吗？打开 PikTag 完成你的档案设置。',
  ...
  ja: {
    ...
    shareAria: '共有',
    tagsAria: 'タグ',
    summarySentence: 'PikTag では、{{name}} のタグは {{tags}} です。',
    tagJoin: '、',
    follow: 'フォロー',
    ...
    setupPendingTitle: 'プロフィールは未設定です',
    setupPendingHeading: 'このプロフィールはまだ設定されていません',
    setupPendingText: 'タグや連絡先がまだ追加されていないため、表示できるものがありません。',
    setupPendingOwner: 'あなたですか？PikTag を開いてプロフィールを完成させましょう。',
  ...
  ko: {
    ...
    shareAria: '공유',
    tagsAria: '태그',
    summarySentence: 'PikTag에서 {{name}}의 태그는 {{tags}}입니다.',
    tagJoin: ', ',
    follow: '팔로우',
    ...
    setupPendingTitle: '프로필이 아직 준비되지 않았습니다',
    setupPendingHeading: '이 프로필은 아직 설정되지 않았습니다',
    setupPendingText: '태그와 연락처를 아직 추가하지 않아 보여드릴 내용이 없습니다.',
    setupPendingOwner: '본인이신가요? PikTag를 열어 프로필 설정을 완료하세요.',
  ...
  es: {
    ...
    shareAria: 'Compartir',
    tagsAria: 'Etiquetas',
    summarySentence: 'En PikTag, las etiquetas de {{name}} son {{tags}}.',
    tagJoin: ', ',
    follow: 'Seguir',
    ...
    setupPendingTitle: 'Perfil aún no configurado',
    setupPendingHeading: 'Este perfil aún no está listo',
    setupPendingText: 'Todavía no ha añadido sus etiquetas ni sus enlaces de contacto, así que no hay nada que mostrar.',
    setupPendingOwner: '¿Eres tú? Abre PikTag para terminar de configurar tu perfil.',
  ...
  fr: {
    ...
    shareAria: 'Partager',
    tagsAria: 'Tags',
    summarySentence: 'Sur PikTag, les tags de {{name}} sont {{tags}}.',
    tagJoin: ', ',
    follow: 'Suivre',
    ...
    setupPendingTitle: 'Profil pas encore configuré',
    setupPendingHeading: 'Ce profil n\'est pas encore prêt',
    setupPendingText: 'Cette personne n\'a pas encore ajouté ses tags ni ses liens de contact : il n\'y a rien à afficher.',
    setupPendingOwner: 'C\'est vous ? Ouvrez PikTag pour terminer la configuration de votre profil.',
  ...
  pt: {
    ...
    tagsAria: 'Etiquetas',
    summarySentence: 'No PikTag, as etiquetas de {{name}} são {{tags}}.',
    tagJoin: ', ',
    follow: 'Seguir',
    ...
    setupPendingTitle: 'Perfil ainda não configurado',
    setupPendingHeading: 'Este perfil ainda não está pronto',
    setupPendingText: 'Ainda não adicionou as suas tags nem os links de contacto, por isso não há nada para mostrar.',
    setupPendingOwner: 'É você? Abra o PikTag para terminar de configurar o seu perfil.',
  ...
  ru: {
    ...
    tagsAria: 'Теги',
    summarySentence: 'В PikTag теги {{name}}: {{tags}}.',
    tagJoin: ', ',
    follow: 'Подписаться',
    ...
    setupPendingTitle: 'Профиль ещё не настроен',
    setupPendingHeading: 'Этот профиль ещё не готов',
    setupPendingText: 'Теги и контакты пока не добавлены, поэтому показывать нечего.',
    setupPendingOwner: 'Это вы? Откройте PikTag и завершите настройку профиля.',
  ...
  ar: {
    ...
    shareAria: 'مشاركة',
    tagsAria: 'الوسوم',
    summarySentence: 'في PikTag، وسوم {{name}} هي {{tags}}.',
    tagJoin: '، ',
    follow: 'متابعة',
    ...
    setupPendingTitle: 'لم يتم إعداد الملف بعد',
    setupPendingHeading: 'هذا الملف الشخصي غير جاهز بعد',
    setupPendingText: 'لم تتم إضافة الوسوم وروابط التواصل بعد، لذا لا يوجد ما يمكن عرضه هنا.',
    setupPendingOwner: 'هل هذا أنت؟ افتح PikTag لإكمال إعداد ملفك الشخصي.',
  ...
  hi: {
    ...
    shareAria: 'साझा करें',
    tagsAria: 'टैग',
    summarySentence: 'PikTag पर {{name}} के टैग: {{tags}}।',
    tagJoin: ', ',
    follow: 'फ़ॉलो करें',
    ...
    setupPendingTitle: 'प्रोफ़ाइल अभी तैयार नहीं है',
    setupPendingHeading: 'यह प्रोफ़ाइल अभी तैयार नहीं है',
    setupPendingText: 'इन्होंने अभी तक अपने टैग और संपर्क लिंक नहीं जोड़े हैं, इसलिए यहाँ दिखाने को कुछ नहीं है।',
    setupPendingOwner: 'क्या यह आप हैं? अपनी प्रोफ़ाइल पूरी करने के लिए PikTag खोलें।',
  ...
  id: {
    ...
    shareAria: 'Bagikan',
    tagsAria: 'Tag',
    summarySentence: 'Di PikTag, tag {{name}} adalah {{tags}}.',
    tagJoin: ', ',
    follow: 'Ikuti',
    ...
    setupPendingTitle: 'Profil belum disiapkan',
    setupPendingHeading: 'Profil ini belum siap',
    setupPendingText: 'Tag dan tautan kontak belum ditambahkan, jadi belum ada yang bisa ditampilkan di sini.',
    setupPendingOwner: 'Ini kamu? Buka PikTag untuk menyelesaikan pengaturan profilmu.',
  ...
  th: {
    ...
    shareAria: 'แชร์',
    tagsAria: 'แท็ก',
    summarySentence: 'บน PikTag แท็กของ {{name}} คือ {{tags}}',
    tagJoin: ', ',
    follow: 'ติดตาม',
    ...
    setupPendingTitle: 'โปรไฟล์ยังไม่ได้ตั้งค่า',
    setupPendingHeading: 'โปรไฟล์นี้ยังไม่พร้อม',
    setupPendingText: 'ยังไม่ได้เพิ่มแท็กและช่องทางติดต่อ จึงยังไม่มีอะไรให้แสดงที่นี่',
    setupPendingOwner: 'นี่คือคุณใช่ไหม เปิด PikTag เพื่อตั้งค่าโปรไฟล์ให้เสร็จ',
  ...
  tr: {
    ...
    shareAria: 'Paylaş',
    tagsAria: 'Etiketler',
    summarySentence: 'PikTag\u2019de {{name}} etiketleri: {{tags}}.',
    tagJoin: ', ',
    follow: 'Takip et',
    ...
    setupPendingTitle: 'Profil henüz hazırlanmadı',
    setupPendingHeading: 'Bu profil henüz hazır değil',
    setupPendingText: 'Etiketlerini ve iletişim bağlantılarını henüz eklememiş, bu yüzden burada gösterilecek bir şey yok.',
    setupPendingOwner: 'Bu sen misin? Profilini tamamlamak için PikTag\'i aç.',
  ...
  bn: {
    ...
    shareAria: 'শেয়ার',
    tagsAria: 'ট্যাগ',
    summarySentence: 'PikTag-এ {{name}}-এর ট্যাগ: {{tags}}।',
    tagJoin: ', ',
    follow: 'ফলো',
    ...
    setupPendingTitle: 'প্রোফাইল এখনো প্রস্তুত নয়',
    setupPendingHeading: 'এই প্রোফাইলটি এখনো প্রস্তুত নয়',
    setupPendingText: 'ট্যাগ ও যোগাযোগের লিঙ্ক এখনো যোগ করা হয়নি, তাই এখানে দেখানোর মতো কিছু নেই।',
    setupPendingOwner: 'এটি কি আপনি? প্রোফাইল সম্পূর্ণ করতে PikTag খুলুন।',
  ...
  de: {
    ...
    shareAria: 'Teilen',
    tagsAria: 'Tags',
    summarySentence: 'Auf PikTag sind die Tags von {{name}}: {{tags}}.',
    tagJoin: ', ',
    follow: 'Folgen',
    ...
    setupPendingTitle: 'Profil noch nicht eingerichtet',
    setupPendingHeading: 'Dieses Profil ist noch nicht fertig',
    setupPendingText: 'Tags und Kontaktlinks wurden noch nicht hinzugefügt, daher gibt es hier nichts zu sehen.',
    setupPendingOwner: 'Bist du das? Öffne PikTag und richte dein Profil fertig ein.',
  ...
  it: {
    ...
    shareAria: 'Condividi',
    tagsAria: 'Tag',
    summarySentence: 'Su PikTag, i tag di {{name}} sono {{tags}}.',
    tagJoin: ', ',
    follow: 'Segui',
    ...
    setupPendingTitle: 'Profilo non ancora configurato',
    setupPendingHeading: 'Questo profilo non è ancora pronto',
    setupPendingText: 'Non ha ancora aggiunto i suoi tag e i link di contatto, quindi non c\'è nulla da mostrare.',
    setupPendingOwner: 'Sei tu? Apri PikTag per completare la configurazione del tuo profilo.',
  ...
  vi: {
    ...
    shareAria: 'Chia sẻ',
    tagsAria: 'Thẻ',
    summarySentence: 'Trên PikTag, các thẻ của {{name}} là {{tags}}.',
    tagJoin: ', ',
    follow: 'Theo dõi',
    ...
    setupPendingTitle: 'Hồ sơ chưa được thiết lập',
    setupPendingHeading: 'Hồ sơ này chưa sẵn sàng',
    setupPendingText: 'Người này chưa thêm thẻ và liên kết liên hệ, nên chưa có gì để hiển thị ở đây.',
    setupPendingOwner: 'Đây là bạn? Mở PikTag để hoàn tất thiết lập hồ sơ.',
  ...
  ur: {
    ...
    shareAria: 'شیئر کریں',
    tagsAria: 'ٹیگز',
    summarySentence: 'PikTag پر {{name}} کے ٹیگز: {{tags}}۔',
    tagJoin: '، ',
    follow: 'فالو کریں',
    ...
    setupPendingTitle: 'پروفائل ابھی تیار نہیں',
    setupPendingHeading: 'یہ پروفائل ابھی تیار نہیں ہے',
    setupPendingText: 'ابھی تک ٹیگ اور رابطے کے لنکس شامل نہیں کیے گئے، اس لیے یہاں دکھانے کو کچھ نہیں۔',
    setupPendingOwner: 'کیا یہ آپ ہیں؟ اپنی پروفائل مکمل کرنے کے لیے PikTag کھولیں۔',
