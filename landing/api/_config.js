...
const TRANSLATIONS = {
  en: {
    ...
    metHero: 'Your meeting tags with {name}',
    nameAsk: 'Add your name so {name} remembers you',
    namePlaceholder: 'Your name',
    nameSubmit: 'Leave your mark',
    nameDone: 'Done — {name} will see you',
  ...
  'zh-TW': {
    ...
    toastCopied: '已複製連結',
    metHero: '你和 {name} 的相遇標籤',
    nameAsk: '輸入名字，讓 {name} 記得你',
    namePlaceholder: '你的名字',
    nameSubmit: '留下記號',
    nameDone: '記下了！{name} 之後會看到你',
  ...
  'zh-CN': {
    ...
    toastCopied: '已复制链接',
    metHero: '你和 {name} 的相遇标签',
    nameAsk: '输入名字，让 {name} 记得你',
    namePlaceholder: '你的名字',
    nameSubmit: '留下记号',
    nameDone: '记下了！{name} 之后会看到你',
    notFoundTitle: '找不到用户',
  ...
  ja: {
    ...
    metHero: '{name} さんとの出会いタグ',
    nameAsk: '名前を入力して {name} さんに覚えてもらおう',
    namePlaceholder: 'あなたの名前',
    nameSubmit: '記録を残す',
    nameDone: '完了！{name} さんがあとで確認できます',
  ...
  ko: {
    ...
    metHero: '{name}님과의 만남 태그',
    nameAsk: '이름을 남겨 {name}님이 기억하게 하세요',
    namePlaceholder: '이름',
    nameSubmit: '기록 남기기',
    nameDone: '완료! {name}님이 나중에 볼 수 있어요',
  ...
  es: {
    ...
    metHero: 'Tus etiquetas de encuentro con {name}',
    nameAsk: 'Pon tu nombre para que {name} te recuerde',
    namePlaceholder: 'Tu nombre',
    nameSubmit: 'Dejar mi marca',
    nameDone: 'Listo — {name} te verá',
  ...
  fr: {
    ...
    metHero: 'Tes tags de rencontre avec {name}',
    nameAsk: 'Laisse ton nom pour que {name} se souvienne de toi',
    namePlaceholder: 'Ton nom',
    nameSubmit: 'Laisser ma trace',
    nameDone: "C'est fait — {name} te verra",
  ...
  pt: {
    ...
    metHero: 'Suas tags de encontro com {name}',
    nameAsk: 'Deixe seu nome para {name} lembrar de você',
    namePlaceholder: 'Seu nome',
    nameSubmit: 'Deixar minha marca',
    nameDone: 'Pronto — {name} vai te ver',
  ...
  ru: {
    ...
    metHero: 'Ваши теги встречи с {name}',
    nameAsk: 'Оставьте имя, чтобы {name} вас запомнил(а)',
    namePlaceholder: 'Ваше имя',
    nameSubmit: 'Оставить след',
    nameDone: 'Готово — {name} вас увидит',
  ...
  ar: {
    ...
    metHero: 'وسوم لقائك مع {name}',
    nameAsk: 'اكتب اسمك ليتذكرك {name}',
    namePlaceholder: 'اسمك',
    nameSubmit: 'اترك أثرك',
    nameDone: 'تم — سيراك {name}',
  ...
  hi: {
    ...
    metHero: '{name} के साथ आपके मुलाक़ात टैग',
    nameAsk: 'नाम डालें ताकि {name} आपको याद रखे',
    namePlaceholder: 'आपका नाम',
    nameSubmit: 'अपना निशान छोड़ें',
    nameDone: 'हो गया — {name} आपको देखेंगे',
  ...
  id: {
    ...
    metHero: 'Tag pertemuanmu dengan {name}',
    nameAsk: 'Isi namamu agar {name} ingat kamu',
    namePlaceholder: 'Namamu',
    nameSubmit: 'Tinggalkan jejak',
    nameDone: 'Selesai — {name} akan melihatmu',
  ...
  th: {
    ...
    metHero: 'แท็กการพบกับ {name}',
    nameAsk: 'ใส่ชื่อเพื่อให้ {name} จำคุณได้',
    namePlaceholder: 'ชื่อของคุณ',
    nameSubmit: 'ฝากร่องรอยไว้',
    nameDone: 'เรียบร้อย — {name} จะเห็นคุณ',
  ...
  tr: {
    ...
    metHero: '{name} ile tanışma etiketlerin',
    nameAsk: 'Adını bırak ki {name} seni hatırlasın',
    namePlaceholder: 'Adın',
    nameSubmit: 'İz bırak',
    nameDone: 'Tamam — {name} seni görecek',
  ...
  bn: {
    ...
    metHero: '{name}-এর সঙ্গে আপনার সাক্ষাৎ ট্যাগ',
    nameAsk: 'নাম লিখুন যাতে {name} আপনাকে মনে রাখে',
    namePlaceholder: 'আপনার নাম',
    nameSubmit: 'চিহ্ন রেখে যান',
    nameDone: 'হয়ে গেছে — {name} আপনাকে দেখবে',
