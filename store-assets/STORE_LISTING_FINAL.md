# PikTag — App Store Listing, FINAL (Tier A, all locales)

Founder-approved **2026-06-09**. **Tier A** = the explicit "The Devil Wears
Prada / Miranda" hook. This is the canonical listing copy and **supersedes the
Tier-B description** in `STORE_LISTING_FILLOUT.md` (that file's ASO/keyword
notes remain valid reference).

Rev 2 — founder-approved **2026-06-10** (Zuckerberg-standard copy pass):
scenario-first rewrites throughout the Description; AI TAG SUGGESTIONS merged
into TAG YOURSELF (same screen, same moment — one section); FEATURES reordered
by user journey (find → be found → meet → remember → ask → reconnect → keep
...
- **Non-Latin KEYWORDS char counts are approximate** — App Store Connect shows
  a live remaining-char counter; verify there before saving (esp. ar/hi/th).

Apple fields per locale: **Subtitle** (≤30) · **Promotional Text** (≤170,
editable later without review) · **Keywords** (≤100, hidden, comma-separated) ·
**Description** (≤4000).
...
PikTag helps you remember people the way humans actually remember people — by what they do, what they love, and where you met them.

Because the problem was never that you don't know enough people.
The problem is forgetting the ones you already know — and not knowing how to start the conversation again.

Rediscover the people you already know. Reconnect with old friends and colleagues. And find exactly the right person the moment you need them.

FEATURES

SEARCH BY NEED
Need a designer? A startup founder? Someone who knows photography? A lawyer, marketer, investor, engineer, or mentor?
Don't search by name. Search by what you need.

TAG YOURSELF
When someone needs "a person like you" — what would they search? Add those words as your tags: your work (#accountant), your interests (#photography), what you're up to (#jobhunting). When someone searches them, you show up.
Can't think of any? PikTag reads your bio and suggests them — done in seconds.
...
PRIVATE TAGS
Notes only you can see: "met at Jenny's wedding", "two cats", "great coffee recs". The details that make people memorable — kept private.
...
Never miss a birthday — or a "we met one year ago today". Small moments of attention keep relationships alive.

WHY PIKTAG?

Your old contacts app answers one question: "Do I have their number?"
PikTag answers a better one: "Who do I know that can help with this?"

A thousand saved contacts are useless if you can't remember who's who. Tags are how you find your way back to the people you already have.
...
- Event-goers and community builders
- Anyone whose circle is growing faster than their memory

Free to get started.

Great relationships grow through introductions. If PikTag helps you reconnect with the right people, share it with someone who'd benefit too.
...
有沒有遇過這種時候：對方明明認識你，你卻怎麼也想不起他的名字？
你記得他是設計師。
他住台北。
他養了兩隻貓。
但名字？完全空白。

PikTag 用人類真正記住一個人的方式，幫你記住他們——他做什麼、他喜歡什麼、你們在哪裡認識。

因為問題從來不是你認識的人不夠多。
真正的問題，是忘了那些你早就認識的人——以及，不知道該怎麼重新開口。

重新找回那些你早就認識的人。和老朋友、老同事再次接上線。在你需要的那一刻，精準找到對的那個人。

主要功能

照需求搜尋
需要一位設計師？一位創業者？一個懂攝影的人？律師、行銷、投資人、工程師，還是一位前輩？
別用名字找，用你的需求找。

給自己貼標籤
朋友需要「你這種人」的時候，會搜什麼詞？把那些詞變成你的標籤：工作（#會計師）、興趣（#攝影）、正在做的事（#找工作）。之後有人搜這些詞，出現的就是你。
想不出來？PikTag 會讀你的簡介幫你推薦——幾秒就好。
...
私人標籤
只有你看得到的小抄：「在 Jenny 婚禮認識的」「養兩隻貓」「咖啡口袋名單很強」。讓一個人變得好記的那些細節，只留給你自己。
...
關係提醒
不錯過任何生日——也不錯過「我們認識滿一年了」。關係，是靠一次次小小的用心活著的。

為什麼是 PikTag？

你的舊通訊錄只回答一個問題：「我有他的電話嗎？」
PikTag 回答一個更好的問題：「我認識的人裡，誰能幫上這個忙？」

存了一千個聯絡人，想不起誰是誰，等於沒存。標籤，就是你找回他們的路。
...
好的關係，在一次次的引介裡長大。如果 PikTag 幫你重新接上對的人，把它分享給同樣會受用的人吧。
...
PikTag 帮你用人类真正记人的方式去记人——记住他们做什么、爱什么、你们在哪里认识。

因为问题从来不是你认识的人不够多，
而是你忘了那些已经认识的人——也不知道该怎么重新开口。

重新发现你已经认识的人，重新联系上老朋友和老同事，并在需要的那一刻，精准找到对的人。

功能亮点

按需求搜索
需要设计师？创业者？懂摄影的人？律师、营销专家、投资人、工程师，还是一位导师？
别按名字搜，按你的需求搜。

给自己打标签
当有人需要"像你这样的人"时，他会搜什么词？把这些词加为你的标签：你的职业（#会计师）、你的爱好（#摄影）、你的近况（#找工作）。有人一搜，你就会出现。
想不出来？PikTag 会读取你的简介自动推荐，几秒钟搞定。
...
私密标签
只有你能看到的备注："在 Jenny 的婚礼上认识的"、"养了两只猫"、"推荐的咖啡馆都很靠谱"。让一个人变得难忘的那些细节——只属于你。
...
关系提醒
不错过任何生日，也不错过"我们认识一周年了"。小小的用心，让关系保持温度。

为什么选 PikTag？

旧的通讯录只能回答一个问题："我有他的电话吗？"
PikTag 回答一个更好的问题："我认识的人里，谁能帮上这个忙？"

存了一千个联系人，记不清谁是谁也没用。标签，就是你找回身边人脉的那条路。
...
好的关系，从一次引荐开始。如果 PikTag 帮你重新联系上了对的人，也把它分享给会受益的朋友吧。
...
PikTag は、人間が本来人を覚えるやり方そのままで覚えられるようにします——その人が何をしているか、何が好きか、どこで出会ったか。

そもそも問題は、知り合いが足りないことではありません。
すでに知っている人を忘れてしまうこと——そして、どう声をかけ直せばいいかわからないことです。

すでに知っている人を再発見する。昔の友人や同僚とつながり直す。そして必要なその瞬間に、まさにぴったりの人を見つける。

主な機能

ニーズで検索
デザイナーが必要？　スタートアップの創業者？　写真に詳しい人？　弁護士、マーケター、投資家、エンジニア、それともメンター？
名前で探すのではなく、いま必要なことで探しましょう。

自分にタグを付ける
誰かが「あなたのような人」を必要とするとき、どんな言葉で検索するでしょう？　その言葉をあなたのタグにしましょう。仕事（#会計士）、趣味（#カメラ）、いまの状況（#転職活動）。誰かがその言葉で検索したとき、あなたが見つかります。
思いつかない？　PikTag がプロフィールを読んで提案してくれるので、数秒で完了です。
...
プライベートタグ
自分にしか見えないメモ：「ジェニーの結婚式で会った」「猫を2匹飼っている」「おいしいコーヒーの店に詳しい」。人を記憶に残すのはこういう小さなディテール——誰にも見られず、自分だけのものに。
...
つながりリマインダー
誕生日も、「出会ってからちょうど1年」も、もう見逃しません。小さな気配りの積み重ねが、関係を生かし続けます。

なぜ PikTag？

これまでの連絡先アプリが答えられるのは「この人の番号、持ってたっけ？」だけ。
PikTag はもっといい問いに答えます。「この件、知り合いの誰に頼める？」

連絡先を1000件保存していても、誰が誰だか思い出せなければ意味がありません。タグは、すでに知っている人たちへ戻るための道しるべです。
...
- デザイナー、開発者、クリエイター
- 学生、研究者
- イベントによく顔を出す人、コミュニティ運営者
- 記憶力より速いペースで人脈が広がっている、すべての人

無料で始められます。

良い関係は紹介から育ちます。PikTag が「会うべき人」との再会を助けてくれたなら、同じように役立ちそうな誰かにもぜひ教えてあげてください。
...
PikTag은 사람이 원래 사람을 기억하는 방식 그대로 기억하게 해 줍니다 — 무슨 일을 하는지, 무엇을 좋아하는지, 어디서 만났는지로요.

문제는 아는 사람이 부족하다는 게 아니었으니까요.
이미 아는 사람을 잊어버린다는 것 — 그리고 어떻게 다시 말을 걸어야 할지 모른다는 것이 문제죠.

이미 아는 사람들을 다시 발견하세요. 오랜 친구, 옛 동료와 다시 연결되세요. 그리고 필요한 바로 그 순간, 정확히 맞는 사람을 찾으세요.

주요 기능

필요한 것으로 검색
디자이너가 필요한가요? 스타트업 창업자? 사진 잘 아는 사람? 변호사, 마케터, 투자자, 엔지니어, 아니면 멘토?
이름으로 찾지 마세요. 지금 필요한 것으로 검색하세요.

나에게 태그 달기
누군가 "나 같은 사람"이 필요할 때, 어떤 단어로 검색할까요? 그 단어들을 내 태그로 추가하세요. 하는 일(#회계사), 관심사(#사진), 요즘 근황(#구직중). 누군가 그 단어를 검색하면, 내가 검색 결과에 나타납니다.
떠오르지 않는다면? PikTag이 프로필 소개를 읽고 태그를 추천해 드려요. 몇 초면 끝납니다.
...
비공개 태그
나만 볼 수 있는 메모: "지은이 결혼식에서 만남", "고양이 두 마리", "커피 맛집을 잘 앎". 사람을 기억에 남게 하는 디테일을, 나만 알고 간직하세요.
...
관계 리마인더
생일도, "우리가 만난 지 딱 1년 되는 날"도 놓치지 마세요. 작은 관심이 관계를 살아 있게 합니다.

왜 PikTag일까요?

기존 연락처 앱이 답할 수 있는 질문은 하나뿐입니다. "이 사람 번호가 있던가?"
PikTag은 더 나은 질문에 답합니다. "내가 아는 사람 중에 이 일을 도와줄 사람이 누구지?"

연락처 천 개를 저장해도 누가 누구인지 기억나지 않으면 소용없습니다. 태그는 이미 내 곁에 있는 사람들에게 돌아가는 길입니다.
...
- 디자이너, 개발자, 크리에이터
- 학생과 연구자
- 행사를 즐겨 찾는 사람과 커뮤니티 운영자
- 인맥이 기억력보다 빠르게 늘어나는 모든 사람

무료로 시작할 수 있습니다.

좋은 관계는 소개를 통해 자랍니다. PikTag 덕분에 꼭 맞는 사람과 다시 연결되었다면, 도움이 될 만한 사람에게도 공유해 주세요.
...
PikTag hilft dir, dich an Menschen so zu erinnern, wie Menschen sich wirklich an Menschen erinnern – über das, was sie tun, was sie lieben und wo ihr euch begegnet seid.
...
TAGGE DICH SELBST
Wenn jemand „eine Person wie dich“ braucht – wonach würde er suchen? Füge genau diese Wörter als Tags hinzu: deine Arbeit (#buchhaltung), deine Interessen (#fotografie), was gerade ansteht (#jobsuche). Sucht jemand danach, tauchst du auf.
Dir fällt nichts ein? PikTag liest deine Bio und schlägt dir Tags vor – fertig in Sekunden.
...
Deine alte Kontakte-App beantwortet eine Frage: „Habe ich die Nummer?“
PikTag beantwortet eine bessere: „Wen kenne ich, der mir dabei helfen kann?“

Tausend gespeicherte Kontakte nützen nichts, wenn du nicht mehr weißt, wer wer ist. Tags sind der Weg zurück zu den Menschen, die du schon hast.

FÜR WEN IST PIKTAG?
- Unternehmer und Startup-Gründer
- Investoren und Business-Profis
- Designer, Entwickler und Kreative
- Studierende und Forschende
- Event-Gänger und Community-Builder
- Alle, deren Netzwerk schneller wächst als ihr Gedächtnis
...
- Investisseurs et professionnels des affaires
- Designers, développeurs et créatifs
- Étudiants et chercheurs
- Habitués d’événements et bâtisseurs de communautés
- Tous ceux dont le cercle grandit plus vite que la mémoire
...
PikTag te ayuda a recordar a las personas como los humanos realmente recordamos: por lo que hacen, lo que aman y dónde las conociste.
...
Cuando alguien necesite «una persona como tú», ¿qué palabras buscaría? Añádelas como tus tags: tu trabajo (#contabilidad), tus intereses (#fotografia), lo que tienes entre manos (#buscoempleo). Cuando alguien las busque, apareces tú.
¿No se te ocurre ninguno? PikTag lee tu biografía y te los sugiere: listo en segundos.
...
Tu vieja app de contactos responde una pregunta: «¿Tengo su número?».
PikTag responde una mejor: «¿A quién conozco que pueda ayudarme con esto?».

Mil contactos guardados no sirven de nada si no recuerdas quién es quién. Los tags son el camino de vuelta a las personas que ya tienes.

¿PARA QUIÉN ES PIKTAG?
- Emprendedores y fundadores de startups
- Inversores y profesionales de los negocios
- Diseñadores, desarrolladores y creadores
- Estudiantes e investigadores
- Asistentes a eventos y creadores de comunidad
- Cualquiera cuyo círculo crece más rápido que su memoria

Empieza gratis.

Las buenas relaciones crecen gracias a las presentaciones. Si PikTag te ayuda a reconectar con las personas indicadas, compártelo con alguien a quien también le sirva.
...
O PikTag ajuda você a lembrar das pessoas do jeito que a gente realmente lembra — pelo que elas fazem, pelo que amam e por onde vocês se conheceram.
...
TAGUEIE VOCÊ MESMO
Quando alguém precisar de "uma pessoa como você" — o que essa pessoa buscaria? Adicione essas palavras como suas tags: seu trabalho (#contador), seus interesses (#fotografia), o que você está vivendo agora (#procurandoemprego). Quando alguém buscar por elas, é você que aparece.
Não vem nada à cabeça? O PikTag lê sua bio e sugere tags por você — pronto em segundos.
...
Seu velho app de contatos responde a uma pergunta: "Eu tenho o número dessa pessoa?"
O PikTag responde a uma pergunta melhor: "Quem eu conheço que pode ajudar com isso?"

Mil contatos salvos não valem nada se você não lembra quem é quem. As tags são o caminho de volta para as pessoas que você já tem.

PARA QUEM É O PIKTAG?
- Empreendedores e fundadores de startup
- Investidores e profissionais de negócios
- Designers, desenvolvedores e criadores
- Estudantes e pesquisadores
- Frequentadores de eventos e construtores de comunidades
- Qualquer pessoa cujo círculo cresce mais rápido do que a memória
...
PikTag ti aiuta a ricordare le persone come le ricordiamo davvero — per quello che fanno, per quello che amano e per dove vi siete conosciuti.
...
TAGGA TE STESSO
Quando a qualcuno serve "una persona come te" — cosa cercherebbe? Aggiungi quelle parole come tag: il tuo lavoro (#commercialista), le tue passioni (#fotografia), quello che stai facendo in questo periodo (#cercolavoro). Quando qualcuno le cerca, compari tu.
Non ti viene in mente niente? PikTag legge la tua bio e te li suggerisce — pronto in pochi secondi.
...
La tua vecchia app dei contatti risponde a una sola domanda: "Ho il suo numero?"
PikTag risponde a una domanda migliore: "Chi conosco che può aiutarmi con questo?"

Mille contatti salvati non servono a niente se non ricordi chi è chi. I tag sono la strada per tornare alle persone che hai già.

PER CHI È PIKTAG?
- Imprenditori e founder di startup
- Investitori e professionisti del business
- Designer, sviluppatori e creativi
- Studenti e ricercatori
- Frequentatori di eventi e costruttori di community
- Chiunque abbia una cerchia che cresce più in fretta della memoria

Inizia gratis.

Le belle relazioni crescono grazie alle presentazioni. Se PikTag ti aiuta a ritrovare le persone giuste, condividilo con qualcuno a cui potrebbe servire.
...
PikTag помогает запоминать людей так, как мы и правда их запоминаем — по тому, чем они занимаются, что любят и где вы познакомились.

Ведь проблема никогда не была в том, что вы знаете слишком мало людей.
Проблема — забывать тех, кого уже знаете, и не понимать, с чего снова начать разговор.

Откройте заново людей, которых уже знаете. Восстановите связь со старыми друзьями и коллегами. И находите именно того, кто нужен, в тот самый момент, когда он нужен.
...
Когда кому-то понадобится «человек вроде вас» — что он введёт в поиск? Добавьте эти слова в свои теги: профессию (#бухгалтер), увлечения (#фотография), то, чем живёте сейчас (#ищуработу). Когда кто-то их ищет — находят вас.
Ничего не приходит в голову? PikTag прочитает раздел «о себе» и сам предложит теги — пара секунд, и готово.
...
ПРИВАТНЫЕ ТЕГИ
Заметки, которые видите только вы: «познакомились на свадьбе у Дженни», «два кота», «знает лучшие кофейни». Детали, благодаря которым люди запоминаются, — и они останутся только у вас.
...
Обычное приложение контактов отвечает на один вопрос: «Есть ли у меня его номер?»
PikTag отвечает на вопрос получше: «Кто из моих знакомых может с этим помочь?»

Тысяча сохранённых контактов бесполезна, если вы не помните, кто есть кто. Теги — это путь обратно к людям, которые у вас уже есть.

ДЛЯ КОГО PIKTAG?
- Предприниматели и основатели стартапов
- Инвесторы и профессионалы бизнеса
- Дизайнеры, разработчики и авторы
- Студенты и исследователи
- Завсегдатаи мероприятий и создатели сообществ
- Все, чей круг знакомств растёт быстрее, чем память

Начать можно бесплатно.

Хорошие отношения растут через знакомства. Если PikTag помог вам снова найти нужных людей — поделитесь им с тем, кому он тоже пригодится.
...
PikTag, insanları tam da insanların hatırladığı gibi hatırlamana yardım eder — ne yaptıklarıyla, neyi sevdikleriyle ve onlarla nerede tanıştığınla.

Çünkü sorun hiçbir zaman yeterince insan tanımaman değildi.
Sorun, zaten tanıdıklarını unutman — ve sohbete yeniden nasıl başlayacağını bilememen.

Zaten tanıdığın insanları yeniden keşfet. Eski dostlarınla ve iş arkadaşlarınla yeniden bağ kur. Ve ihtiyacın olduğu anda tam olarak doğru kişiyi bul.

ÖZELLİKLER

İHTİYACA GÖRE ARA
Bir tasarımcı mı lazım? Bir startup kurucusu? Fotoğraftan anlayan biri? Avukat, pazarlamacı, yatırımcı, mühendis ya da mentor?
İsme göre arama. İhtiyacına göre ara.

KENDİNİ ETİKETLE
Birinin "senin gibi birine" ihtiyacı olsa — ne yazıp arardı? O kelimeleri etiket olarak ekle: işin (#muhasebeci), ilgi alanların (#fotoğrafçılık), şu sıralar ne yaptığın (#işarıyorum). Biri onları aradığında karşısına sen çıkarsın.
Aklına bir şey gelmiyor mu? PikTag biyografini okur ve senin için etiket önerir — saniyeler içinde hazır.
...
ÖZEL ETİKETLER
Sadece senin görebildiğin notlar: "Zeynep'in düğününde tanıştık", "iki kedisi var", "kahve mekânlarını iyi bilir". İnsanları akılda kalıcı yapan ayrıntılar — sana özel kalır.
...
İLİŞKİ HATIRLATICILARI
Hiçbir doğum gününü kaçırma — "tanışmamızın üzerinden tam bir yıl geçti" anlarını da. Küçük ilgi gösterileri ilişkileri canlı tutar.

NEDEN PikTag?

Eski rehber uygulaman tek bir soruya cevap verir: "Numarası bende var mı?"
PikTag daha iyisine cevap verir: "Bu konuda bana yardım edebilecek kimi tanıyorum?"

Kimin kim olduğunu hatırlamıyorsan kayıtlı bin kişi hiçbir işe yaramaz. Etiketler, zaten sahip olduğun insanlara geri dönüş yolundur.

PikTag KİMLER İÇİN?
- Girişimciler ve startup kurucuları
- Yatırımcılar ve iş dünyası profesyonelleri
- Tasarımcılar, geliştiriciler ve içerik üreticileri
- Öğrenciler ve araştırmacılar
- Etkinlik tutkunları ve topluluk kuranlar
- Çevresi hafızasından daha hızlı genişleyen herkes

Başlamak ücretsiz.

Güzel ilişkiler tanıştırmalarla büyür. PikTag doğru insanlarla yeniden bağ kurmana yardımcı olduysa, onu bundan faydalanacak biriyle de paylaş.
...
PikTag membantumu mengingat orang seperti cara manusia benar-benar mengingat — lewat apa yang mereka kerjakan, apa yang mereka sukai, dan di mana kalian bertemu.
...
TAG DIRIMU SENDIRI
Kalau ada yang butuh "orang seperti kamu" — kata apa yang akan mereka cari? Jadikan kata-kata itu tag-mu: pekerjaanmu (#akuntan), minatmu (#fotografi), kesibukanmu saat ini (#carikerja). Saat seseorang mencarinya, kamulah yang muncul.
Bingung mau mulai dari mana? PikTag membaca bio-mu dan memberi saran tag — beres dalam hitungan detik.
...
- Investor dan profesional bisnis
- Desainer, developer, dan kreator
- Pelajar dan peneliti
- Penggemar acara dan pembangun komunitas
- Siapa pun yang lingkarannya tumbuh lebih cepat daripada ingatannya

Gratis untuk memulai.

Hubungan yang baik tumbuh lewat perkenalan. Kalau PikTag membantumu tersambung lagi dengan orang yang tepat, bagikan ke orang lain yang juga akan terbantu.
...
PikTag giúp bạn nhớ người khác theo đúng cách con người vẫn nhớ về nhau — qua việc họ làm, điều họ yêu thích, và nơi hai bạn đã gặp nhau.

Bởi vấn đề chưa bao giờ là bạn quen quá ít người.
Vấn đề là quên mất những người bạn đã quen — và không biết bắt đầu lại cuộc trò chuyện thế nào.

Khám phá lại những người bạn đã quen. Kết nối lại với bạn cũ và đồng nghiệp cũ. Và tìm được đúng người ngay khoảnh khắc bạn cần.

TÍNH NĂNG

TÌM THEO NHU CẦU
Cần một nhà thiết kế? Một nhà sáng lập startup? Một người rành nhiếp ảnh? Luật sư, người làm marketing, nhà đầu tư, kỹ sư hay mentor?
Đừng tìm theo tên. Hãy tìm theo điều bạn cần.

TỰ GẮN TAG CHO MÌNH
Khi ai đó cần "một người như bạn" — họ sẽ gõ tìm gì? Hãy thêm những từ đó làm tag của bạn: công việc (#ketoan), sở thích (#nhiepanh), việc bạn đang theo đuổi (#timviec). Khi có người tìm những từ đó, bạn sẽ xuất hiện.
Chưa nghĩ ra tag nào? PikTag sẽ đọc phần giới thiệu của bạn và gợi ý giúp — xong trong vài giây.
...
TAG RIÊNG TƯ
Ghi chú chỉ mình bạn thấy: "gặp ở đám cưới của Lan", "nuôi hai con mèo", "rành quán cà phê ngon". Những chi tiết khiến một người trở nên đáng nhớ — được giữ kín cho riêng bạn.
...
LỜI NHẮC GIỮ KẾT NỐI
Không bao giờ bỏ lỡ sinh nhật — hay khoảnh khắc "tròn một năm kể từ ngày mình gặp nhau". Những quan tâm nhỏ giữ cho mối quan hệ luôn ấm.

VÌ SAO CHỌN PikTag?

Ứng dụng danh bạ cũ của bạn trả lời một câu hỏi: "Mình có số của họ không?"
PikTag trả lời một câu hỏi hay hơn: "Mình quen ai có thể giúp việc này?"

Cả nghìn liên hệ đã lưu cũng vô dụng nếu bạn không nhớ ai là ai. Tag chính là con đường đưa bạn quay lại với những người bạn vốn đã có.

PikTag DÀNH CHO AI?
- Doanh nhân và nhà sáng lập startup
- Nhà đầu tư và người làm kinh doanh
- Nhà thiết kế, lập trình viên và nhà sáng tạo
- Sinh viên và nhà nghiên cứu
- Người hay đi sự kiện và người xây dựng cộng đồng
- Bất kỳ ai có vòng quan hệ mở rộng nhanh hơn trí nhớ của mình

Bắt đầu miễn phí.

Những mối quan hệ tốt đẹp lớn lên từ những lời giới thiệu. Nếu PikTag giúp bạn kết nối lại với đúng người, hãy chia sẻ nó với một người bạn nghĩ cũng sẽ cần.
...
PikTag ช่วยให้คุณจดจำผู้คนแบบที่มนุษย์จำกันจริง ๆ — จากสิ่งที่เขาทำ สิ่งที่เขารัก และที่ที่คุณพบกัน

เพราะปัญหาไม่เคยอยู่ที่คุณรู้จักคนไม่มากพอ
ปัญหาคือการลืมคนที่คุณรู้จักอยู่แล้ว — และไม่รู้จะเริ่มบทสนทนาอีกครั้งยังไง

ค้นพบคนที่คุณรู้จักอยู่แล้วอีกครั้ง กลับมาเชื่อมต่อกับเพื่อนเก่าและเพื่อนร่วมงานเก่า และเจอคนที่ใช่เป๊ะ ๆ ในจังหวะที่คุณต้องการ

ฟีเจอร์เด่น

ค้นหาตามความต้องการ
ต้องการดีไซเนอร์? ผู้ก่อตั้งสตาร์ทอัพ? คนที่เก่งเรื่องถ่ายภาพ? ทนาย นักการตลาด นักลงทุน วิศวกร หรือเมนเทอร์?
อย่าค้นหาด้วยชื่อ ค้นหาด้วยสิ่งที่คุณต้องการ

แท็กตัวเอง
เวลาใครสักคนต้องการ "คนแบบคุณ" — เขาจะค้นหาด้วยคำว่าอะไร? ใส่คำเหล่านั้นเป็นแท็กของคุณ: งานที่ทำ (#นักบัญชี) สิ่งที่ชอบ (#ถ่ายภาพ) สิ่งที่กำลังทำอยู่ (#หางาน) เมื่อใครค้นหาคำเหล่านั้น คุณก็จะปรากฏขึ้นมา
คิดไม่ออก? PikTag อ่านไบโอของคุณแล้วแนะนำให้ — เสร็จในไม่กี่วินาที
...
แท็กส่วนตัว
โน้ตที่มีแต่คุณเห็น: "เจอกันที่งานแต่งของเจนนี่" "เลี้ยงแมวสองตัว" "แนะนำร้านกาแฟเด็ด ๆ ได้" รายละเอียดที่ทำให้คนน่าจดจำ — เก็บเป็นส่วนตัวเสมอ
...
เตือนความสัมพันธ์
ไม่พลาดวันเกิดอีกต่อไป — รวมถึง "วันนี้เมื่อปีที่แล้วเราเจอกันครั้งแรก" ความใส่ใจเล็ก ๆ น้อย ๆ คือสิ่งที่ทำให้ความสัมพันธ์ยังมีชีวิต

ทำไมต้อง PikTag?

แอปรายชื่อแบบเดิมตอบได้แค่คำถามเดียว: "ฉันมีเบอร์เขาไหม?"
PikTag ตอบคำถามที่ดีกว่านั้น: "ฉันรู้จักใครที่ช่วยเรื่องนี้ได้บ้าง?"

รายชื่อเป็นพันก็ไร้ค่าถ้าคุณจำไม่ได้ว่าใครเป็นใคร แท็กคือเส้นทางที่พาคุณกลับไปหาคนที่คุณมีอยู่แล้ว

PikTag เหมาะกับใคร?
- ผู้ประกอบการและผู้ก่อตั้งสตาร์ทอัพ
- นักลงทุนและคนทำงานสายธุรกิจ
- ดีไซเนอร์ นักพัฒนา และครีเอเตอร์
- นักศึกษาและนักวิจัย
- คนชอบไปอีเวนต์และนักสร้างคอมมูนิตี้
- ทุกคนที่วงสังคมโตเร็วกว่าความจำของตัวเอง

เริ่มต้นใช้ได้ฟรี

ความสัมพันธ์ดี ๆ เติบโตจากการแนะนำต่อ ถ้า PikTag ช่วยให้คุณได้กลับมาเชื่อมต่อกับคนที่ใช่ ก็ส่งต่อให้อีกคนที่น่าจะได้ประโยชน์เหมือนกัน
...
يساعدك PikTag على تذكّر الناس كما يتذكرهم البشر فعلًا — بما يعملون، وما يحبون، وأين التقيت بهم.

لأن المشكلة لم تكن يومًا أنك لا تعرف عددًا كافيًا من الناس.
المشكلة هي أن تنسى من تعرفهم أصلًا — وألا تعرف كيف تبدأ الحديث معهم من جديد.

أعد اكتشاف من تعرفهم بالفعل. أعد التواصل مع أصدقائك وزملائك القدامى. واعثر على الشخص المناسب تمامًا في اللحظة التي تحتاجه فيها.

المزايا

ابحث حسب حاجتك
تحتاج إلى مصمم؟ مؤسس شركة ناشئة؟ شخص يفهم في التصوير؟ محامٍ أو مسوّق أو مستثمر أو مهندس أو مرشد؟
لا تبحث بالاسم. ابحث بما تحتاجه.

وسِم نفسك
عندما يحتاج أحدهم إلى «شخص مثلك» — بماذا سيبحث؟ أضف تلك الكلمات كوسوم لك: عملك (#محاسب)، اهتماماتك (#تصوير)، وما تمر به الآن (#أبحث_عن_عمل). وحين يبحث أحدهم عنها، ستظهر أنت.
لا يخطر لك شيء؟ يقرأ PikTag نبذتك ويقترح عليك الوسوم — وينتهي الأمر في ثوانٍ.
...
وسوم خاصة
ملاحظات لا يراها أحد سواك: «التقينا في حفل زفاف جيني»، «لديه قطتان»، «يعرف أفضل المقاهي». التفاصيل الصغيرة التي تجعل الناس عالقين في الذاكرة — تبقى خاصة بك.
...
تذكيرات العلاقات
لن يفوتك عيد ميلاد بعد اليوم — ولا «مرت سنة على لقائنا الأول اليوم». لحظات الاهتمام الصغيرة هي ما يُبقي العلاقات حية.

لماذا PikTag؟

تطبيق جهات الاتصال القديم يجيب عن سؤال واحد: «هل لدي رقمه؟»
أما PikTag فيجيب عن سؤال أفضل: «من أعرف ممن يستطيع المساعدة في هذا؟»

ألف جهة اتصال محفوظة لا تنفعك إن كنت لا تتذكر من يكون كل منهم. الوسوم هي طريق عودتك إلى الأشخاص الذين تعرفهم أصلًا.

لمن صُمم PikTag؟
- رواد الأعمال ومؤسسو الشركات الناشئة
- المستثمرون والمهنيون في عالم الأعمال
- المصممون والمطورون وصناع المحتوى
- الطلاب والباحثون
- روّاد الفعاليات وبناة المجتمعات
- كل من تنمو دائرة معارفه أسرع من ذاكرته

ابدأ مجانًا.

العلاقات الرائعة تنمو بالتعارف. إذا ساعدك PikTag على إعادة التواصل مع الأشخاص المناسبين، فشاركه مع شخص سيستفيد منه أيضًا.
...
PikTag आपको लोगों को वैसे याद रखने में मदद करता है जैसे इंसान सच में याद रखते हैं — उनके काम से, उनकी पसंद से, और उस जगह से जहाँ आप मिले थे।

क्योंकि दिक़्क़त कभी यह थी ही नहीं कि आप कम लोगों को जानते हैं।
दिक़्क़त है जिन्हें आप जानते हैं उन्हें भूल जाना — और यह न जानना कि बातचीत दोबारा शुरू कैसे करें।

जिन्हें आप पहले से जानते हैं, उन्हें फिर से खोजिए। पुराने दोस्तों और सहकर्मियों से दोबारा जुड़िए। और ठीक उसी पल सही इंसान तक पहुँचिए जब आपको उसकी ज़रूरत हो।

फ़ीचर्स

ज़रूरत से खोजें
डिज़ाइनर चाहिए? स्टार्टअप फ़ाउंडर? फ़ोटोग्राफ़ी जानने वाला कोई? वकील, मार्केटर, निवेशक, इंजीनियर या मेंटर?
नाम से मत खोजिए। उससे खोजिए जो आपको चाहिए।

खुद को टैग करें
जब किसी को "आपके जैसा इंसान" चाहिए होगा — वह क्या खोजेगा? वही शब्द अपने टैग बना लीजिए: आपका काम (#अकाउंटेंट), आपके शौक़ (#फोटोग्राफी), आप इन दिनों क्या कर रहे हैं (#नौकरी_की_तलाश)। जब कोई इन्हें खोजेगा, तो आप सामने आएँगे।
कुछ सूझ नहीं रहा? PikTag आपकी बायो पढ़कर टैग सुझा देता है — सेकंडों में काम पूरा।
...
प्राइवेट टैग
नोट्स जो सिर्फ़ आप देख सकते हैं: "जेनी की शादी में मिले थे", "दो बिल्लियाँ हैं", "बढ़िया कॉफ़ी की जगहें बताते हैं"। वही छोटी-छोटी बातें जो लोगों को यादगार बनाती हैं — पूरी तरह प्राइवेट।
...
रिश्तों के रिमाइंडर
अब कोई जन्मदिन नहीं छूटेगा — और न ही "आज ही के दिन एक साल पहले हम मिले थे"। ध्यान के यही छोटे-छोटे पल रिश्तों को ज़िंदा रखते हैं।

PikTag ही क्यों?

आपका पुराना कॉन्टैक्ट्स ऐप बस एक सवाल का जवाब देता है: "क्या मेरे पास उसका नंबर है?"
PikTag उससे बेहतर सवाल का जवाब देता है: "मैं ऐसे किसे जानता हूँ जो इसमें मदद कर सके?"

हज़ार सेव किए हुए कॉन्टैक्ट किसी काम के नहीं अगर याद ही न हो कि कौन कौन है। टैग ही वह रास्ता हैं जो आपको आपके अपने लोगों तक वापस ले जाते हैं।

PikTag किनके लिए है?
- उद्यमी और स्टार्टअप फ़ाउंडर
- निवेशक और बिज़नेस प्रोफ़ेशनल
- डिज़ाइनर, डेवलपर और क्रिएटर
- छात्र और शोधकर्ता
- इवेंट में जाने वाले और कम्युनिटी बनाने वाले
- हर वह इंसान जिसका दायरा उसकी याददाश्त से तेज़ बढ़ रहा है

शुरुआत मुफ़्त है।

अच्छे रिश्ते एक-दूसरे से मिलवाने से बढ़ते हैं। अगर PikTag ने आपको सही लोगों से दोबारा जोड़ा हो, तो इसे किसी ऐसे इंसान के साथ शेयर कीजिए जिसके यह काम आ सके।
